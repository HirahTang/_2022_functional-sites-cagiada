...
#####
# Produce tne fitness score produced by ESM-1v/ESM-2 in a zero-shot manner
def create_parser():
    ...
    for model_location in args.model_location:
        ...
        if isinstance(model, MSATransformer):
            ...
            if args.scoring_strategy == "wt-marginals":
                ...
                df['{}_{}'.format(model_location, args.scoring_strategy)] = df.apply(
                    lambda row: label_row(
                ...
                tqdm.pandas()
                df['{}_{}'.format(model_location, args.scoring_strategy)] = df.progress_apply(
